 ...
 */
class Memberlevelhistory extends CB_Controller
{
     ...
     * 페이지 이동시 필요한 정보입니다
     */
    public $pagedir = 'member/memberlevelhistory';

    /**
     * 모델을 로딩합니다
     */
    protected $models = array('Member_level_history');

    /**
     * 이 컨트롤러의 메인 모델 이름입니다
     */
    protected $modelname = 'Member_level_history_model';
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_member_memberlevelhistory_index';
         ...
         */
        $search_option = array('member.mem_userid' => '회원아이디', 'member.mem_nickname' => '회원닉네임', 'mlh_datetime' => '날짜', 'mlh_reason' => '이유', 'mlh_ip' => 'IP');
