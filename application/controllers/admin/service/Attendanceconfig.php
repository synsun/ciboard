 ...
 */
class Attendanceconfig extends CB_Controller
{
     ...
     * 페이지 이동시 필요한 정보입니다
     */
    public $pagedir = 'service/attendanceconfig';
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_service_attendanceconfig_index';
...
반갑습니다.';
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_service_attendanceconfig_points';
        $this->load->event($eventname);
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_service_attendanceconfig_cleanlog';
        $this->load->event($eventname);
