...
class Cmall_config_model extends CB_Model
{

    /**
     * 테이블명
     */
    public $_table = 'cmall_config';

    /**
     * 사용되는 테이블의 프라이머리키
     */
    public $meta_key = 'ccf_key';

    public $meta_value = 'ccf_value';

    public $cache_name= 'cmall-config-model-get'; // 캐시 사용시 프리픽스
