...
<div class="wrapmemo">
    한마디
    <?php
    $attributes = array('class' => 'attendance_box text-center mb20 mt10', 'name' => 'attendanceform', 'id' => 'attendanceform');
    echo form_open('', $attributes);
    ?>
        <input type="text" name="memo" value="<?php echo html_escape(element(0, element('default_memo', $view))); ?>" id="att_memo" class="form-control" onClick="this.value='';" />
        <button type="button" name="change_memo" class="btn btn-default btn-sm" id="change_memo"><span class="fa fa-refresh"></span></button>
        <button type="button" name="submit" class="btn btn-success btn-sm" id="add_attendance">출첵하기</button>
    <?php echo form_close(); ?>
