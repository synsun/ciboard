    ...
    ?>
        <div class="credit">
            <div class="credit_method">
                <div><?php echo $this->depositconfig->item('deposit_name'); ?> <span class="textblue"><?php echo number_format($this->member->item('total_deposit') + 0); ?><?php echo $this->depositconfig->item('deposit_unit'); ?></span>중, <input type="number" class="form-control px100" id="deposit" name="deposit" value="0" onkeydown="if (event.keyCode ==13) return false;" onkeyup="num_deposit_to_point()" /><?php echo $this->depositconfig->item('deposit_unit'); ?> 전환</div>
            </div>
            <div class="credit_method">
