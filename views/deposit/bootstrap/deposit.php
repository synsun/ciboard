            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-right"><label class=" btn-block" for="charge_<?php echo element('0', $val); ?>"><?php echo number_format(element('1', $val));?> <?php echo $this->depositconfig->item('deposit_unit'); ?></label></td>
                    </tr>
                <?php
                    }
                }
            ...
            <table class="table table-striped table-bordered table-hover mt10">
                <tbody>
                    <tr>
                        ...
                        <td class="form-inline"><input type="text" name="mem_realname" class="form-control" value="<?php echo $this->member->item('mem_nickname'); ?>" /></td>
                    </tr>
                    <tr>
