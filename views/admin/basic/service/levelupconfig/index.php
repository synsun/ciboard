                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><input type="number" name="register[<?php echo $i; ?>]" class="form-control" value="<?php echo set_value('register[' . $i . ']', element($i, element('register', $levelupconfig)) + 0); ?>" />일</td>
                                    <td><input type="number" name="point_required[<?php echo $i; ?>]" class="form-control" value="<?php echo set_value('point_required[' . $i . ']', element($i, element('point_required', $levelupconfig)) + 0); ?>" />점</td>
                                    <td><input type="number" name="point_use[<?php echo $i; ?>]" class="form-control" value="<?php echo set_value('point_use[' . $i . ']', element($i, element('point_use', $levelupconfig)) + 0); ?>" />점</td>
                                    <td><input type="number" name="post_num[<?php echo $i; ?>]" class="form-control" value="<?php echo set_value('post_num[' . $i . ']', element($i, element('post_num', $levelupconfig)) + 0); ?>" />개</td>
                                    <td><input type="number" name="comment_num[<?php echo $i; ?>]" class="form-control" value="<?php echo set_value('comment_num[' . $i . ']', element($i, element('comment_num', $levelupconfig)) + 0); ?>" />개</td>
                                </tr>
                            <?php
                                }
                            }
