        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="attendance_page_count" id="attendance_page_count" value="<?php echo set_value('attendance_page_count', element('attendance_page_count', element('data', $view)) + 0); ?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="attendance_memo_length" id="attendance_memo_length" value="<?php echo set_value('attendance_memo_length', element('attendance_memo_length', element('data', $view)) + 0); ?>" /> 글자 이내
                    </div>
                </div>
                <hr />
                <div class="form-group">
