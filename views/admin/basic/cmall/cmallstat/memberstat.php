        ...
        <div class="box-table-header">
            <form class="form-inline" name="flist" action="<?php echo current_url(); ?>" method="get" >
                ...
                <div class="btn-group" role="group" aria-label="...">
                    <button type="button" class="btn <?php echo ($this->input->get('orderby') !== 'money') ? 'btn-success' : 'btn-default'; ?> btn-sm" onclick="forder_submit('');">결제회수순</button>
                    <button type="button" class="btn <?php echo ($this->input->get('orderby') === 'money') ? 'btn-success' : 'btn-default'; ?> btn-sm" onclick="forder_submit('money');">결제금액순</button>
                </div>
