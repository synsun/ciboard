<div class="box">
    <div class="box-header">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/approve_bank_to_contents'); ?>" onclick="return check_form_changed();">무통장입금 완료처리시</a></li>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_email_admin_approve_bank_to_contents_title" id="cmall_email_admin_approve_bank_to_contents_title" value="<?php echo set_value('cmall_email_admin_approve_bank_to_contents_title', element('cmall_email_admin_approve_bank_to_contents_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <div class="alert alert-warning">내용은 <strong>views/emailform/cmall/email_admin_approve_bank_to_contents.php</strong> 파일에서 별도 관리됩니다</div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_email_user_approve_bank_to_contents_title" id="cmall_email_user_approve_bank_to_contents_title" value="<?php echo set_value('cmall_email_user_approve_bank_to_contents_title', element('cmall_email_user_approve_bank_to_contents_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <div class="alert alert-warning">내용은 <strong>views/emailform/cmall/email_user_approve_bank_to_contents.php</strong> 파일에서 별도 관리됩니다</div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_note_admin_approve_bank_to_contents_title" id="cmall_note_admin_approve_bank_to_contents_title" value="<?php echo set_value('cmall_note_admin_approve_bank_to_contents_title', element('cmall_note_admin_approve_bank_to_contents_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('cmall_note_admin_approve_bank_to_contents_content', set_value('cmall_note_admin_approve_bank_to_contents_content', element('cmall_note_admin_approve_bank_to_contents_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_note_user_approve_bank_to_contents_title" id="cmall_note_user_approve_bank_to_contents_title" value="<?php echo set_value('cmall_note_user_approve_bank_to_contents_title', element('cmall_note_user_approve_bank_to_contents_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('cmall_note_user_approve_bank_to_contents_content', set_value('cmall_note_user_approve_bank_to_contents_content', element('cmall_note_user_approve_bank_to_contents_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 form-inline has-success ">
                    <textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="cmall_sms_admin_approve_bank_to_contents_content" id="cmall_sms_admin_approve_bank_to_contents_content"><?php echo set_value('cmall_sms_admin_approve_bank_to_contents_content', element('cmall_sms_admin_approve_bank_to_contents_content', element('data', $view))); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">
                ...
                <div class="col-sm-10 form-inline has-success ">
                    <textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="cmall_sms_user_approve_bank_to_contents_content" id="cmall_sms_user_approve_bank_to_contents_content"><?php echo set_value('cmall_sms_user_approve_bank_to_contents_content', element('cmall_sms_user_approve_bank_to_contents_content', element('data', $view))); ?></textarea>
                </div>
            </div>
...
$(function() {
    $('#fadminwrite').validate({
        rules: {
            cmall_note_admin_approve_bank_to_contents_content : {'required_smarteditor' : true },
            cmall_note_user_approve_bank_to_contents_content : {'required_smarteditor' : true }
        }
    });
});
...
$(document).on('click', '.reset_email_to_admin', function() {
    $('#cmall_email_admin_approve_bank_to_contents_title').val('[입금처리완료] {회원닉네임}님의 입금처리요청이 완료되었습니다');
});
$(document).on('click', '.reset_email_to_user', function() {
    $('#cmall_email_user_approve_bank_to_contents_title').val('[{홈페이지명}] 입금이 확인되어 주문처리가 완료되었습니다');
});
$(document).on('click', '.reset_note_to_admin', function() {
    $('#cmall_note_admin_approve_bank_to_contents_title').val('[입금처리완료] {회원닉네임}님의 입금처리요청이 완료되었습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">{회원닉네임}님의 입금처리요청이 완료되었습니다</td></tr></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><p>안녕하세요</p><p>{회원닉네임}님의 입금확인 처리가 완료되었습니다</p><p>감사합니다</p></div><p><a href="{홈페이지주소}" target="_blank" style="font-weight:bold;">홈페이지 가기</a></p><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["cmall_note_admin_approve_bank_to_contents_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_note_to_user', function() {
    $('#cmall_note_user_approve_bank_to_contents_title').val('입금이 확인되어 주문처리가 완료되었습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">{회원닉네임}님의 입금처리요청이 완료되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><p>안녕하세요 {회원닉네임}님</p><p>구매해주셔서 감사합니다</p><p>입금이 확인되어 이제 정상적으로 상품 이용이 가능합니다</p><p>감사합니다</p></div><p><a href="{홈페이지주소}" target="_blank" style="font-weight:bold;">홈페이지 가기</a></p><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["cmall_note_user_approve_bank_to_contents_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_sms_to_admin', function() {
    $('#cmall_sms_admin_approve_bank_to_contents_content').val('[무통장입금확인] {회원닉네임}님의 무통장입금요청이확인되었습니다');
});
$(document).on('click', '.reset_sms_to_user', function() {
    $('#cmall_sms_user_approve_bank_to_contents_content').val('[{홈페이지명}] 입금이확인되었습니다. 구매하신상품다운로드가가능합니다');
});
