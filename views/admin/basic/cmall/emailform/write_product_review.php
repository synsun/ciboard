<div class="box">
    <div class="box-header">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/write_product_review'); ?>" onclick="return check_form_changed();">상품후기 작성시</a></li>
    ...
    <div class="box-table">
        ...
        ?>
            ...
            <div class="alert alert-success">
                <p>치환가능변수 : <strong>{홈페이지명}</strong>, <strong>{회사명}</strong>, <strong>{홈페이지주소}</strong>, <strong>{회원아이디}</strong>, <strong>{회원닉네임}</strong>, <strong>{회원실명}</strong>, <strong>{회원이메일}</strong>, <strong>{메일수신여부}</strong>, <strong>{쪽지수신여부}</strong>, <strong>{문자수신여부}</strong>, <strong>{회원아이피}</strong>, <strong>{상품명}</strong>, <strong>{상품주소}</strong>, <strong>{후기제목}</strong>, <strong>{후기내용}</strong></p>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_email_admin_write_product_review_title" id="cmall_email_admin_write_product_review_title" value="<?php echo set_value('cmall_email_admin_write_product_review_title', element('cmall_email_admin_write_product_review_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('cmall_email_admin_write_product_review_content', set_value('cmall_email_admin_write_product_review_content', element('cmall_email_admin_write_product_review_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_email_user_write_product_review_title" id="cmall_email_user_write_product_review_title" value="<?php echo set_value('cmall_email_user_write_product_review_title', element('cmall_email_user_write_product_review_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('cmall_email_user_write_product_review_content', set_value('cmall_email_user_write_product_review_content', element('cmall_email_user_write_product_review_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_note_admin_write_product_review_title" id="cmall_note_admin_write_product_review_title" value="<?php echo set_value('cmall_note_admin_write_product_review_title', element('cmall_note_admin_write_product_review_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('cmall_note_admin_write_product_review_content', set_value('cmall_note_admin_write_product_review_content', element('cmall_note_admin_write_product_review_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="cmall_note_user_write_product_review_title" id="cmall_note_user_write_product_review_title" value="<?php echo set_value('cmall_note_user_write_product_review_title', element('cmall_note_user_write_product_review_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('cmall_note_user_write_product_review_content', set_value('cmall_note_user_write_product_review_content', element('cmall_note_user_write_product_review_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 form-inline has-success ">
                    <textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="cmall_sms_admin_write_product_review_content" id="cmall_sms_admin_write_product_review_content"><?php echo set_value('cmall_sms_admin_write_product_review_content', element('cmall_sms_admin_write_product_review_content', element('data', $view))); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">
                ...
                <div class="col-sm-10 form-inline has-success ">
                    <textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="cmall_sms_user_write_product_review_content" id="cmall_sms_user_write_product_review_content"><?php echo set_value('cmall_sms_user_write_product_review_content', element('cmall_sms_user_write_product_review_content', element('data', $view))); ?></textarea>
                </div>
            </div>
...
$(function() {
    $('#fadminwrite').validate({
        rules: {
            cmall_email_admin_write_product_review_content : {'required_smarteditor' : true },
            cmall_email_user_write_product_review_content : {'required_smarteditor' : true },
            cmall_note_admin_write_product_review_content : {'required_smarteditor' : true },
            cmall_note_user_write_product_review_content : {'required_smarteditor' : true }
        }
    });
});
...
$(document).on('click', '.reset_email_to_admin', function() {
    $('#cmall_email_admin_write_product_review_title').val('[상품후기] {상품명} 상품 후기가 작성되었습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 관리자님,</span><br />상품후기가 등록되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><strong>[후기제목]</strong></div><div>{후기제목}</div><div>&nbsp;</div><div><strong>[후기내용]</strong></div><div>{후기내용}</div><div>&nbsp;</div><div><a href="{상품주소}" target="_blank"><strong>[상품페이지 보기]</strong></a></div><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["cmall_email_admin_write_product_review_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_email_to_user', function() {
    $('#cmall_email_user_write_product_review_title').val('[홈페이지명] {상품명} 상품 후기를 작성해주셔서 감사합니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 {회원닉네임}님,</span><br />상품후기가 등록되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><strong>[후기제목]</strong></div><div>{후기제목}</div><div>&nbsp;</div><div><strong>[후기내용]</strong></div><div>{후기내용}</div><div>&nbsp;</div><div><a href="{상품주소}" target="_blank"><strong>[상품페이지 보기]</strong></a></div><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["cmall_email_user_write_product_review_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_note_to_admin', function() {
    $('#cmall_note_admin_write_product_review_title').val('[상품후기] {상품명} 상품 후기가 작성되었습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 관리자님,</span><br />상품후기가 등록되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><strong>[후기제목]</strong></div><div>{후기제목}</div><div>&nbsp;</div><div><strong>[후기내용]</strong></div><div>{후기내용}</div><div>&nbsp;</div><div><a href="{상품주소}" target="_blank"><strong>[상품페이지 보기]</strong></a></div><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["cmall_note_admin_write_product_review_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_note_to_user', function() {
    $('#cmall_note_user_write_product_review_title').val('{상품명} 상품 후기를 작성해주셔서 감사합니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 {회원닉네임}님,</span><br />상품후기가 등록되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><strong>[후기제목]</strong></div><div>{후기제목}</div><div>&nbsp;</div><div><strong>[후기내용]</strong></div><div>{후기내용}</div><div>&nbsp;</div><div><a href="{상품주소}" target="_blank"><strong>[상품페이지 보기]</strong></a></div><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["cmall_note_user_write_product_review_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_sms_to_admin', function() {
    $('#cmall_sms_admin_write_product_review_content').val('[상품후기] {상품명} 상품후기가 작성되었습니다');
});
$(document).on('click', '.reset_sms_to_user', function() {
    $('#cmall_sms_user_write_product_review_content').val('[홈페이지명] {상품명} 상품후기를 작성해주셔서 감사합니다');
});
//]]>
</script>
