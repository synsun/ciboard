        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        PC - <input type="number" class="form-control" name="cmall_product_thumb_width" id="cmall_product_thumb_width" value="<?php echo set_value('cmall_product_thumb_width', element('cmall_product_thumb_width', element('data', $view)) + 0); ?>" />px,
                        모바일 - <input type="number" class="form-control" name="cmall_product_mobile_thumb_width" id="cmall_product_mobile_thumb_width" value="<?php echo set_value('cmall_product_mobile_thumb_width', element('cmall_product_mobile_thumb_width', element('data', $view)) + 0); ?>" />px
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        PC - <input type="number" class="form-control" name="cmall_product_review_thumb_width" id="cmall_product_review_thumb_width" value="<?php echo set_value('cmall_product_review_thumb_width', element('cmall_product_review_thumb_width', element('data', $view)) + 0); ?>" />px,
                        모바일 - <input type="number" class="form-control" name="cmall_product_review_mobile_thumb_width" id="cmall_product_review_mobile_thumb_width" value="<?php echo set_value('cmall_product_review_mobile_thumb_width', element('cmall_product_review_mobile_thumb_width', element('data', $view)) + 0); ?>" />px
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        PC - <input type="number" class="form-control" name="cmall_product_qna_thumb_width" id="cmall_product_qna_thumb_width" value="<?php echo set_value('cmall_product_qna_thumb_width', element('cmall_product_qna_thumb_width', element('data', $view)) + 0); ?>" />px,
                        모바일 - <input type="number" class="form-control" name="cmall_product_qna_mobile_thumb_width" id="cmall_product_qna_mobile_thumb_width" value="<?php echo set_value('cmall_product_qna_mobile_thumb_width', element('cmall_product_qna_mobile_thumb_width', element('data', $view)) + 0); ?>" />px
