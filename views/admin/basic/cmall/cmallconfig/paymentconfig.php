            ...
            <div class="form-horizontal">
                ...
                <div class="form-group" id="kcp_info_anchor">
                    <div class="pg_info pg_kcp clearfix">
                        ...
                        <div class="col-sm-10 form-inline">
                            <span class="sitecode">SR</span> <input type="text" class="form-control pg_input" name="pg_kcp_mid" id="pg_kcp_mid" value="<?php echo set_value('pg_kcp_mid', element('pg_kcp_mid', element('data', $view))); ?>" />
                            
                            <div class="help-block">NHN KCP 에서 받은 SR 로 시작하는 영대문자, 숫자 혼용 총 5자리 중 SR 을 제외한 나머지 3자리 SITE CODE 를 입력하세요.<br> 만약, 사이트코드가 SR로 시작하지 않는다면 NHN KCP에 사이트코드 변경 요청을 하십시오. 예) SR9A3</div>
                        </div>
                    </div>
                    <div class="pg_info pg_kcp clearfix">
                ...
                <div class="form-group" id="lg_info_anchor">
                    <div class="pg_info pg_lg clearfix">
                        ...
                        <div class="col-sm-10 form-inline">
                            <span class="sitecode">si_</span> <input type="text" class="form-control pg_input" name="pg_lg_mid" id="pg_lg_mid" value="<?php echo set_value('pg_lg_mid', element('pg_lg_mid', element('data', $view))); ?>" />
                            <div class="help-block">LG유플러스에서 받은 si_ 로 시작하는 상점 ID를 입력하세요.<br>만약, 상점 ID가 si_로 시작하지 않는다면 LG유플러스에 사이트코드 변경 요청을 하십시오. 예) si_lguplus</div>
                        </div>
                    </div>
                    <div class="pg_info pg_lg clearfix">
                ...
                <div class="form-group" id="inicis_info_anchor">
                    <div class="clearfix pg_info pg_inicis">
                        ...
                        <div class="col-sm-10 form-inline">
                            <span class="sitecode">SIR</span> <input type="text" class="form-control pg_input" name="pg_inicis_mid" id="pg_inicis_mid" value="<?php echo set_value('pg_inicis_mid', element('pg_inicis_mid', element('data', $view))); ?>" />
                            <div class="help-block">
                            KG이니시스로 부터 발급 받으신 상점아이디(MID) 10자리 중 SIR 을 제외한 나머지 7자리를 입력 합니다.<br>만약, 상점아이디가 SIR로 시작하지 않는다면 계약담당자에게 변경 요청을 해주시기 바랍니다. (Tel. 02-3430-5858) 예) SIRpaytest
                            </div>
                        </div>
                    </div>
                    <div class="clearfix pg_info pg_inicis">
