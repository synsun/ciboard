<div class="box">
    <div class="box-header">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/general'); ?>" onclick="return check_form_changed();">일반기능</a></li>
        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="cmall_cart_keep_days" value="<?php echo set_value('cmall_cart_keep_days', element('cmall_cart_keep_days', element('data', $view)) + 0); ?>" /> 일
                    </div>
                </div>
