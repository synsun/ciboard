        ...
        ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir); ?>">장바구니현황</a></li>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            <th><a href="<?php echo element('cct_id', element('sort', $view)); ?>">번호</a></th>
                            <th>상품이미지</th>
                            ...
                            <th>세부사항</th>
                            <th>수량</th>
                            <th><a href="<?php echo element('cct_datetime', element('sort', $view)); ?>">보관일시</a></th>
                            <th><a href="<?php echo element('cct_ip', element('sort', $view)); ?>">IP</a></th>
                            <th>회원명</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo number_format(element('cct_count', $result)); ?></td>
                            <td><?php echo display_datetime(element('cct_datetime', $result), 'full'); ?></td>
                            <td><a href="?sfield=cct_ip&amp;skeyword=<?php echo display_admin_ip(element('cct_ip', $result)); ?>"><?php echo display_admin_ip(element('cct_ip', $result)); ?></a></td>
                            <td><?php echo element('display_name', $result); ?> <?php if (element('mem_userid', $result)) { ?> ( <a href="?sfield=cmall_cart.mem_id&amp;skeyword=<?php echo element('mem_id', $result); ?>"><?php echo html_escape(element('mem_userid', $result)); ?></a> ) <?php } ?></td>
