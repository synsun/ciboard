        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_write" value="<?php echo set_value('point_write', element('point_write', element('data', $view)) + 0); ?>" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_comment" value="<?php echo set_value('point_comment', element('point_comment', element('data', $view)) + 0); ?>" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        원글작성시 지급했던 포인트 회수 +
                        <input type="number" class="form-control" name="point_post_delete" value="<?php echo set_value('point_post_delete', element('point_post_delete', element('data', $view)) + 0); ?>" /> 포인트를 추가로 차감
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        원글작성시 지급했던 포인트 회수 +
                        <input type="number" class="form-control" name="point_admin_post_delete" value="<?php echo set_value('point_admin_post_delete', element('point_admin_post_delete', element('data', $view)) + 0); ?>" /> 포인트를 추가로 차감
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        댓글작성시 지급했던 포인트 회수 +
                        <input type="number" class="form-control" name="point_comment_delete" value="<?php echo set_value('point_comment_delete', element('point_comment_delete', element('data', $view)) + 0); ?>" /> 포인트를 추가로 차감
                        <span class="help-inline">추가로 차감하기 원하는 포인트를 양수로 입력해주세요</span>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        댓글작성시 지급했던 포인트 회수 +
                        <input type="number" class="form-control" name="point_admin_comment_delete" value="<?php echo set_value('point_admin_comment_delete', element('point_admin_comment_delete', element('data', $view)) + 0); ?>" /> 포인트를 추가로 차감
                        <span class="help-inline">관리자가 일반사용자의 글을 삭제시 해당 사용자에게 추가로 차감하기 원하는 포인트를 양수로 입력해주세요</span>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_fileupload" value="<?php echo set_value('point_fileupload', element('point_fileupload', element('data', $view)) + 0); ?>" /> <span class="help-inline">파일 업로드시 1회</span>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_filedownload" value="<?php echo set_value('point_filedownload', element('point_filedownload', element('data', $view)) + 0); ?>" /> <span class="help-inline">파일 다운로드한 사람에게 1회 적용됩니다</span>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_filedownload_uploader" value="<?php echo set_value('point_filedownload_uploader', element('point_filedownload_uploader', element('data', $view)) + 0); ?>" /> <span class="help-inline">파일을 다운로드 할 때마다 파일을 업로드한 사람에게 매번 포인트가 지급됩니다</span>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_read" value="<?php echo set_value('point_read', element('point_read', element('data', $view)) + 0); ?>" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_post_like" value="<?php echo set_value('point_post_like', element('point_post_like', element('data', $view)) + 0); ?>" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_post_dislike" value="<?php echo set_value('point_post_dislike', element('point_post_dislike', element('data', $view)) + 0); ?>" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_post_liked" value="<?php echo set_value('point_post_liked', element('point_post_liked', element('data', $view)) + 0); ?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_post_disliked" value="<?php echo set_value('point_post_disliked', element('point_post_disliked', element('data', $view)) + 0); ?>" />
                        <span class="help-inline">원글 작성자에게 지급되는 포인트입니다</span>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_comment_like" value="<?php echo set_value('point_comment_like', element('point_comment_like', element('data', $view)) + 0); ?>" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_comment_dislike" value="<?php echo set_value('point_comment_dislike', element('point_comment_dislike', element('data', $view)) + 0); ?>" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_comment_liked" value="<?php echo set_value('point_comment_liked', element('point_comment_liked', element('data', $view)) + 0); ?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="point_comment_disliked" value="<?php echo set_value('point_comment_disliked', element('point_comment_disliked', element('data', $view)) + 0); ?>" />
                        <span class="help-inline">댓글 작성자에게 지급되는 포인트입니다</span>
                    </div>
                    <div class="col-sm-2">
