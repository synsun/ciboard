        ...
        ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            <th><a href="<?php echo element('pta_id', element('sort', $view)); ?>">번호</a></th>
                            <th><a href="<?php echo element('pta_tag', element('sort', $view)); ?>">태그명</a></th>
                            <th>게시판</th>
                            <th>게시물</th>
                            <th>작성자</th>
                            <th>작성일</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="?sfield=pta_tag&amp;skeyword=<?php echo element('pta_tag', $result); ?>"><?php echo html_escape(element('pta_tag', $result)); ?></a> <a href="<?php echo goto_url( site_url('tags/?tag=' . element('pta_tag', $result))); ?>" target="_blank"><span class="fa fa-external-link"></span></a></td>
                            <td><a href="<?php echo goto_url(element('boardurl', $result)); ?>" target="_blank"><?php echo html_escape(element('brd_name', element('board', $result))); ?></a></td>
                            <td><a href="?sfield=post_tag.post_id&amp;skeyword=<?php echo element('post_id', $result); ?>"><?php echo html_escape(element('post_title', $result)); ?></a> <a href="<?php echo goto_url(element('posturl', $result)); ?>" target="_blank"><span class="fa fa-external-link"></span></a></td>
