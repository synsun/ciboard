                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="<?php echo goto_url(prep_url(html_escape(element('pln_url', element('post_link', $result))))); ?>" target="_blank"><?php echo prep_url(html_escape(element('pln_url', element('post_link', $result)))); ?></a></td>
                            <td><?php echo display_datetime(element('plc_datetime', $result), 'full'); ?></td>
                            <td><a href="?sfield=plc_ip&amp;skeyword=<?php echo display_admin_ip(element('plc_ip', $result)); ?>"><?php echo display_admin_ip(element('plc_ip', $result)); ?></a></td>
                            <td><?php echo element('display_name', $result); ?> <?php if (element('mem_userid', element('member', $result))) { ?> ( <a href="?sfield=post_link_click_log.mem_id&amp;skeyword=<?php echo element('mem_id', $result); ?>"><?php echo html_escape(element('mem_userid', element('member', $result))); ?></a> ) <?php } ?></td>
