        ...
        ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation"><a href="<?php echo admin_url('board/trash'); ?>">원글 </a></li>
                    <li role="presentation" class="active"><a href="<?php echo admin_url('board/trash_comment'); ?>">댓글 </a></li>
                </ul>
                <?php
                ob_start();
                ?>
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="<?php echo element('posturl', $result); ?>" target="_blank"><?php echo html_escape(element('post_title', $result)); ?></td>
                            <td><a href="<?php echo admin_url($this->pagedir . '/view/' . element('cmt_id', $result)); ?>"><?php echo element('content', $result); ?></a></td>
