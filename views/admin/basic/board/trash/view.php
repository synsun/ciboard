            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>제목</th>
                            <td><div class="textbox"><?php echo html_escape(element('post_title', element('data', $view))); ?></div></td>
                        </tr>
                        <tr>
                            <th>글쓴이</th>
                        ...
                        <tr>
                            <th>등록일</th>
                            <td><div class="textbox"><?php echo display_datetime(element('post_datetime', element('data', $view)), 'full'); ?></div></td>
                        </tr>
                        <tr>
                            <th>내용</th>
