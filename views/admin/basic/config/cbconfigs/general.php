        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        PC - <input type="number" class="form-control" name="popup_thumb_width" id="popup_thumb_width" value="<?php echo set_value('popup_thumb_width', element('popup_thumb_width', element('data', $view)) + 0); ?>" />px,
                        모바일 - <input type="number" class="form-control" name="popup_mobile_thumb_width" id="popup_mobile_thumb_width" value="<?php echo set_value('popup_mobile_thumb_width', element('popup_mobile_thumb_width', element('data', $view)) + 0); ?>" />px
