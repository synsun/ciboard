                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="checkbox">
                            <label for="send_sms_register_admin">
                                <input type="checkbox" name="send_sms_register_admin" id="send_sms_register_admin" value="1" <?php echo set_checkbox('send_sms_register_admin', '1', (element('send_sms_register_admin', element('data', $view)) ? true : false)); ?> /> <strong>최고관리자</strong>에게 <strong>문자</strong>를 발송합니다 (문자수신동의 여부와 상관없이 <strong>무조건 발송</strong>합니다)
                            </label>
                        </div>
                        <div class="checkbox">
                            <label for="send_sms_register_user">
                                <input type="checkbox" name="send_sms_register_user" id="send_sms_register_user" value="1" <?php echo set_checkbox('send_sms_register_user', '1', (element('send_sms_register_user', element('data', $view)) ? true : false)); ?> /> <strong>회원</strong>에게 <strong>문자</strong>를 발송합니다 (문자수신에 <strong>동의한 회원</strong>에게만 발송합니다)
                            </label>
                        </div>
                        <div class="checkbox">
                            <label for="send_sms_register_alluser">
                                <input type="checkbox" name="send_sms_register_alluser" id="send_sms_register_alluser" value="1" <?php echo set_checkbox('send_sms_register_alluser', '1', (element('send_sms_register_alluser', element('data', $view)) ? true : false)); ?> /> <strong>회원</strong>에게 <strong>문자</strong>를 발송합니다 (문자수신 동의에 상관없이 <strong>무조건 발송</strong>합니다)
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="checkbox">
                            <label for="send_sms_memberleave_admin">
                                <input type="checkbox" name="send_sms_memberleave_admin" id="send_sms_memberleave_admin" value="1" <?php echo set_checkbox('send_sms_memberleave_admin', '1', (element('send_sms_memberleave_admin', element('data', $view)) ? true : false)); ?> /> <strong>최고관리자</strong>에게 <strong>문자</strong>를 발송합니다 (문자수신동의 여부와 상관없이 <strong>무조건 발송</strong>합니다)
                            </label>
                        </div>
                        <div class="checkbox">
                            <label for="send_sms_memberleave_user">
                                <input type="checkbox" name="send_sms_memberleave_user" id="send_sms_memberleave_user" value="1" <?php echo set_checkbox('send_sms_memberleave_user', '1', (element('send_sms_memberleave_user', element('data', $view)) ? true : false)); ?> /> <strong>회원</strong>에게 <strong>문자</strong>를 발송합니다 (문자수신에 <strong>동의한 회원</strong>에게만 발송합니다)
                            </label>
                        </div>
                        <div class="checkbox">
                            <label for="send_sms_memberleave_alluser">
                                <input type="checkbox" name="send_sms_memberleave_alluser" id="send_sms_memberleave_alluser" value="1" <?php echo set_checkbox('send_sms_memberleave_alluser', '1', (element('send_sms_memberleave_alluser', element('data', $view)) ? true : false)); ?> /> <strong>회원</strong>에게 <strong>문자</strong>를 발송합니다 (문자수신 동의에 상관없이 <strong>무조건 발송</strong>합니다)
                            </label>
                        </div>
                    </div>
                </div>
