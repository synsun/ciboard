                    ...
                    <table class="table table-hover table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>현금/카드 변동</th>
                                <th>포인트 변동</th>
                                <th><?php echo $this->depositconfig->item('deposit_name'); ?> 잔액</th>
                                <th>수정</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-right"><?php echo number_format(element('dep_deposit', $result)); ?><?php echo $this->depositconfig->item('deposit_unit'); ?></td>
                                ...
                                <td class="text-right"><?php echo number_format(element('dep_deposit_sum', $result)); ?><?php echo $this->depositconfig->item('deposit_unit'); ?></td>
