        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 form-inline">
                        현금/카드로 예치금 구매시 결제금액의 <input type="text" class="form-control" name="deposit_charge_point" value="<?php echo set_value('deposit_charge_point', element('deposit_charge_point', element('data', $view)) + 0); ?>" />% 가 포인트로 적립됩니다
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 form-inline">
                        <input type="text" class="form-control" name="deposit_point" value="<?php echo set_value('deposit_point', element('deposit_point', element('data', $view)) + 0); ?>" /> 포인트로 1 예치금 구매가 가능합니다. 최소 <input type="number" class="form-control" name="deposit_point_min" value="<?php echo set_value('deposit_point_min', element('deposit_point_min', element('data', $view)) + 0); ?>" /> 포인트 이상으로 구매가 가능합니다
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 form-inline">
                        1 예치금을 <input type="text" class="form-control" name="deposit_refund_point" value="<?php echo set_value('deposit_refund_point', element('deposit_refund_point', element('data', $view)) + 0); ?>" /> 포인트로 전환이 가능합니다. 최소 <input type="number" class="form-control" name="deposit_refund_point_min" value="<?php echo set_value('deposit_refund_point_min', element('deposit_refund_point_min', element('data', $view)) + 0); ?>" /> 예치금 이상을 전환 가능합니다
                    </div>
                </div>
