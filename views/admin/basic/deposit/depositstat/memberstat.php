        ...
        <div class="box-table-header">
            <form class="form-inline" name="flist" action="<?php echo current_url(); ?>" method="get" >
                ...
                <div class="btn-group" role="group" aria-label="...">
                    ...
                    <button type="button" class="btn <?php echo ($this->input->get('orderby') === 'deposit') ? 'btn-success' : 'btn-default'; ?> btn-sm" onclick="forder_submit('deposit');">적립<?php echo html_escape($this->depositconfig->item('deposit_name')); ?>순</button>
                </div>
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <thead>
                    <tr>
                        ...
                        <th>회원명</th>
                        <th>결제회수</th>
                        <th><?php echo html_escape($this->depositconfig->item('deposit_name')); ?></th>
                        <th>비율</th>
                        <th>그래프</th>
                    </tr>
                </thead>
