<div class="box">
    <div class="box-header">
        <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/cash_to_deposit'); ?>" onclick="return check_form_changed();">카드/이체 등으로 예치금 구매시</a></li>
    ...
    <div class="box-table">
        ...
        ?>
            ...
            <div class="alert alert-success">
                <p>치환가능변수 : <strong>{홈페이지명}</strong>, <strong>{회사명}</strong>, <strong>{홈페이지주소}</strong>, <strong>{회원아이디}</strong>, <strong>{회원닉네임}</strong>, <strong>{회원실명}</strong>, <strong>{회원이메일}</strong>, <strong>{메일수신여부}</strong>, <strong>{쪽지수신여부}</strong>, <strong>{문자수신여부}</strong>, <strong>{회원아이피}</strong>, <strong>{결제금액}</strong>, <strong>{전환예치금액}</strong>, <strong>{예치금명}</strong>, <strong>{예치금단위}</strong></p>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="deposit_email_admin_cash_to_deposit_title" id="deposit_email_admin_cash_to_deposit_title" value="<?php echo set_value('deposit_email_admin_cash_to_deposit_title', element('deposit_email_admin_cash_to_deposit_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('deposit_email_admin_cash_to_deposit_content', set_value('deposit_email_admin_cash_to_deposit_content', element('deposit_email_admin_cash_to_deposit_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="deposit_email_user_cash_to_deposit_title" id="deposit_email_user_cash_to_deposit_title" value="<?php echo set_value('deposit_email_user_cash_to_deposit_title', element('deposit_email_user_cash_to_deposit_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('deposit_email_user_cash_to_deposit_content', set_value('deposit_email_user_cash_to_deposit_content', element('deposit_email_user_cash_to_deposit_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="deposit_note_admin_cash_to_deposit_title" id="deposit_note_admin_cash_to_deposit_title" value="<?php echo set_value('deposit_note_admin_cash_to_deposit_title', element('deposit_note_admin_cash_to_deposit_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('deposit_note_admin_cash_to_deposit_content', set_value('deposit_note_admin_cash_to_deposit_content', element('deposit_note_admin_cash_to_deposit_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="form-group col-sm-12">
                        <input type="text" class="form-control" name="deposit_note_user_cash_to_deposit_title" id="deposit_note_user_cash_to_deposit_title" value="<?php echo set_value('deposit_note_user_cash_to_deposit_title', element('deposit_note_user_cash_to_deposit_title', element('data', $view))); ?>" />
                    </div>
                    <div class="form-group col-sm-12">
                        <?php echo display_dhtml_editor('deposit_note_user_cash_to_deposit_content', set_value('deposit_note_user_cash_to_deposit_content', element('deposit_note_user_cash_to_deposit_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 form-inline has-success ">
                    <textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="deposit_sms_admin_cash_to_deposit_content" id="deposit_sms_admin_cash_to_deposit_content"><?php echo set_value('deposit_sms_admin_cash_to_deposit_content', element('deposit_sms_admin_cash_to_deposit_content', element('data', $view))); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">
                ...
                <div class="col-sm-10 form-inline has-success ">
                    <textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="deposit_sms_user_cash_to_deposit_content" id="deposit_sms_user_cash_to_deposit_content"><?php echo set_value('deposit_sms_user_cash_to_deposit_content', element('deposit_sms_user_cash_to_deposit_content', element('data', $view))); ?></textarea>
                </div>
            </div>
...
$(function() {
    $('#fadminwrite').validate({
        rules: {
            deposit_email_admin_cash_to_deposit_content : {'required_smarteditor' : true },
            deposit_email_user_cash_to_deposit_content : {'required_smarteditor' : true },
            deposit_note_admin_cash_to_deposit_content : {'required_smarteditor' : true },
            deposit_note_user_cash_to_deposit_content : {'required_smarteditor' : true }
        }
    });
});
...
$(document).on('click', '.reset_email_to_admin', function() {
    $('#deposit_email_admin_cash_to_deposit_title').val('[결제 알림] {회원닉네임}님이 결제하셨습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 관리자님,</span><br />결제가 정상적으로 처리되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><p>안녕하세요</p><p>{회원닉네임}님이 결제하셨습니다</p><p>회원님께서 결제하신 내용입니다</p><p>결제금액 : {결제금액} 원</p><p>전환되는 {예치금명} : {전환예치금액}{예치금단위}</p><p>감사합니다</p></div><p><a href="{홈페이지주소}" target="_blank" style="font-weight:bold;">홈페이지 가기</a></p><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["deposit_email_admin_cash_to_deposit_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_email_to_user', function() {
    $('#deposit_email_user_cash_to_deposit_title').val('[{홈페이지명}] 결제가 완료되었습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 {회원닉네임}님,</span><br />결제가 정상적으로 처리되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><p>안녕하세요 {회원닉네임}님</p><p>구매해주셔서 감사합니다</p><p>{회원닉네임}님께서 구매하신 내용입니다</p><p>결제금액 : {결제금액} 원</p><p>전환되는 {예치금명} : {전환예치금액}{예치금단위}</p><p>감사합니다</p></div><p><a href="{홈페이지주소}" target="_blank" style="font-weight:bold;">홈페이지 가기</a></p><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["deposit_email_user_cash_to_deposit_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_note_to_admin', function() {
    $('#deposit_note_admin_cash_to_deposit_title').val('[결제 알림] {회원닉네임}님이 결제하셨습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 관리자님,</span><br />결제가 정상적으로 처리되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><p>안녕하세요</p><p>{회원닉네임}님이 결제하셨습니다</p><p>회원님께서 결제하신 내용입니다</p><p>결제금액 : {결제금액} 원</p><p>전환되는 {예치금명} : {전환예치금액}{예치금단위}</p><p>감사합니다</p></div><p><a href="{홈페이지주소}" target="_blank" style="font-weight:bold;">홈페이지 가기</a></p><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["deposit_note_admin_cash_to_deposit_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_note_to_user', function() {
    $('#deposit_note_user_cash_to_deposit_title').val('결제가 완료되었습니다');
    var sHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid rgb(226,226,225);border-right: 1px solid rgb(226,226,225);background-color: rgb(255,255,255);border-top:10px solid #348fe2; border-bottom:5px solid #348fe2;border-collapse: collapse;"><tr><td style="font-size:12px;padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><span style="font-size:14px;font-weight:bold;color:rgb(0,0,0)">안녕하세요 {회원닉네임}님,</span><br />결제가 정상적으로 처리되었습니다</td></tr><tr style="border-top:1px solid #e2e2e2; border-bottom:1px solid #e2e2e2;"><td style="padding:20px 30px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;"><div><p>안녕하세요 {회원닉네임}님</p><p>구매해주셔서 감사합니다</p><p>{회원닉네임}님께서 구매하신 내용입니다</p><p>결제금액 : {결제금액} 원</p><p>전환되는 {예치금명} : {전환예치금액}{예치금단위}</p><p>감사합니다</p></div><p><a href="{홈페이지주소}" target="_blank" style="font-weight:bold;">홈페이지 가기</a></p><p>&nbsp;</p></td></tr><tr><td style="padding:10px;font-family: Arial,sans-serif;color: rgb(0,0,0);font-size: 14px;line-height: 20px;text-align:center;">{홈페이지명}</td></tr></table>';
    oEditors.getById["deposit_note_user_cash_to_deposit_content"].exec("SET_CONTENTS", [sHTML]);
});
$(document).on('click', '.reset_sms_to_admin', function() {
    $('#deposit_sms_admin_cash_to_deposit_content').val('[결제알림] {회원닉네임}님, 결제금액 : {결제금액} 원');
});
$(document).on('click', '.reset_sms_to_user', function() {
    $('#deposit_sms_user_cash_to_deposit_content').val('[{홈페이지명}] 결제완료 : {결제금액} 원 - 감사합니다');
});
//]]>
</script>
