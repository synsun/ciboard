        ...
        ?>
            ...
            <div class="box-table">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?php echo $this->depositconfig->item('deposit_name'); ?> 충전</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group some_cash">
                        ...
                        <div class="col-sm-10 form-inline">
                            <input type="number" class="form-control" name="dep_cash" id="dep_cash" value="<?php echo set_value('dep_cash', element('dep_cash', element('data', $view)) + 0); ?>" /> 원
                        </div>
                    </div>
