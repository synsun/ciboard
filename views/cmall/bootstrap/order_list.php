        ...
        <table class="table table-striped table-hover  ">
            ...
            ?>
                <tr>
                    ...
                    <td class="text-right"><?php echo number_format(element('cor_total_money', $result) + 0); ?>원</td>
                    <td class="text-right text-primary"><?php echo number_format(element('cor_cash', $result) + element('cor_deposit', $result) + 0); ?>원</td>
                    <td class="text-right text-danger"><strong><?php echo number_format(element('cor_cash_request', $result) - element('cor_cash', $result)); ?></strong>원</td>
