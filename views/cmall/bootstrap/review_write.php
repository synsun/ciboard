    ...
    <div class="form-horizontal ">
        ...
        ?>
            ...
            <div class="form-group mt20">
                ...
                <div class="col-sm-10">
                    <?php echo display_dhtml_editor('cre_content', set_value('cre_content', element('cre_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = $this->cmallconfig->item('use_cmall_product_review_dhtml'), $editor_type = $this->cmallconfig->item('cmall_product_review_editor_type')); ?>
                </div>
            </div>
            <div class="form-group mt20">
