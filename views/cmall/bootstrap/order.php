        ...
        <div class="pay-info">
            ...
            <ul>
                ...
                <li>
                    ...
                    ?>
                        <span class="info-tit">보유<?php echo html_escape($this->depositconfig->item('deposit_name')); ?> </span> <?php echo number_format($this->member->item('total_deposit') + 0);?> <?php echo html_escape($this->depositconfig->item('deposit_unit')); ?>
                        ( 최대
                        <?php
                    ...
                    <li>
                        ...
                        <?php echo html_escape($this->depositconfig->item('deposit_name')); ?> </span> <input type="text" name="order_deposit" id="order_deposit" class="form-control px100" value="0" /> 원
                    <?php } else { ?>
