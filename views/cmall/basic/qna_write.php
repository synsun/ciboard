    ...
    <div class="form-horizontal mt20">
        ...
        ?>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="input per90" name="cqa_title" id="cqa_title" value="<?php echo set_value('cqa_title', element('cqa_title', element('data', $view))); ?>" placeholder="제목을 입력해주세요" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <?php if ($this->cmallconfig->item('cmall_email_user_write_product_qna_reply')) { ?>
                    ...
                    <?php } ?>
                    <?php if ($this->cmallconfig->item('cmall_sms_user_write_product_qna_reply')) { ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo display_dhtml_editor('cqa_content', set_value('cqa_content', element('cqa_content', element('data', $view))), $classname = 'dhtmleditor', $is_dhtml_editor = $this->cmallconfig->item('use_cmall_product_qna_dhtml'), $editor_type = $this->cmallconfig->item('cmall_product_qna_editor_type')); ?>
                </div>
            </div>
            <div class="form-group col-sm-6">
                <div class="pull-right">
                    <a href="javascript:;" class="btn btn-default btn-sm" onClick="window.close();">취소</a>
