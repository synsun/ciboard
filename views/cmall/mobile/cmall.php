    ...
    ?>
        <div class="main_box pull-left">
            ...
            <ul class="cmall-detail">
                <li><i class="fa fa-heart"></i> 찜 <?php echo number_format(element('cit_wish_count', $item) + 0); ?></li>
                <li><i class="fa fa-shopping-cart"></i> 구매 <?php echo number_format(element('cit_sell_count', $item) + 0); ?></li>
                <li class="cmall-price pull-right"> <?php echo number_format(element('cit_price', $item) + 0); ?>원</li>
            </ul>
        </div>
    <?php
        }
    ...
    ?>
        <div class="main_box pull-left">
            ...
            <ul class="cmall-detail">
                <li><i class="fa fa-heart"></i> 찜 <?php echo number_format(element('cit_wish_count', $item) + 0); ?></li>
                <li><i class="fa fa-shopping-cart"></i> 구매 <?php echo number_format(element('cit_sell_count', $item) + 0); ?></li>
                <li class="cmall-price pull-right"> <?php echo number_format(element('cit_price', $item) + 0); ?></li>
            </ul>
        </div>
    <?php
        }
